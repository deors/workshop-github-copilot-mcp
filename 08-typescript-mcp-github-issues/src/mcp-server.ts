...
const server = new McpServer({
    name: 'GitHub issues MCP Server (streamable version)',
    description: 'An MCP server that integrates with GitHub issues through streamable HTTP. The permission boundary is given by the GitHub token provided at runtime in the GITHUB_TOKEN environment variable.',
    version: '1.0.0',
